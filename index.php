...
<div id="container">
    ...
    <div id="sidebar">
        <div class="optionL"><a href="age.php">Graj </a> </div> 
    </div>

    <div id="content">
        <h1>Treśc główna/zawartość strony/oferta sklepu</h1> 
            <div class="dottedline"></div>  <br/><br/>
        <span class="bigtitle">Program do gry w lotto</span>
        <div style="height: 15px;"></div>
        <br/>
        Aby zagrac w lotto, najpopularnieszą grę na świecie kliknij przycisk -->GRAJ<-- po lewej stroie lub -->Lotto<-- u góry w menu. Miłej zabawy!! :)
    </div>
